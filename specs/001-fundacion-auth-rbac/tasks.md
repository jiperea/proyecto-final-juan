...
- [ ] T040 [US1] Handler `POST /v1/auth/logout` (204 si sesión no revocada —aunque token rotado/cuenta disabled—; 401 si sesión ya revocada; 503 si BD caída; limpia cookies) — `backend/src/handlers/auth/logout.ts` (FR-003/018, D12)
