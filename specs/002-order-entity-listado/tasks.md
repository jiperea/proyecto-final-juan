...
- [ ] T002 Extender seed con **≥30 órdenes** + **≥2 technicians nuevos** (`technician2`, `technician3`): activas de
...
- [ ] T010 [P] [US1] **[Red]** Auth/authorize (2 niveles):
...
- [ ] T011 [P] [US1] **[Red]** Test de arquitectura (mecanismo fijado, T-001): **spy** que asevera que el handler
...
- [ ] T016 [US1] **[Red]** Test de redacción con poder de detección (T-003): **forzar** el log de un objeto
