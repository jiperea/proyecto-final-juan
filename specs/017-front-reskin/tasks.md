...
- [ ] T005 [Red] [US1] Añadir test de render (`frontend/tests/unit/accent-primary.test.tsx`) que verifique que la acción **primaria** de cada pantalla expone la clase de acento (`btn--primary`) y que el badge de cada estado renderiza etiqueta de texto (color no único). (FR-002/FR-003)
