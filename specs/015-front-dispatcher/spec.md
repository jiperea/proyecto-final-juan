...
- Q: [G1-M08] Formato UUID a validar → A: **forma general de UUID (8-4-4-4-12 hex), SIN fijar la versión**. (Corregido en la validación contra el stack real: el backend emite **UUIDv7** —p. ej. `018f1000-0000-7000-8000-...`—, así que pinar v1–v5 rechazaba destinos legítimos. La decisión inicial "v1–v5" era errónea. El chequeo de cliente es solo de formato; la validez real la decide el backend con `INVALID_ASSIGNEE`.)
