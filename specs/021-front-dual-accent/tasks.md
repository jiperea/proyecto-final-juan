...
- [ ] T004 [US1] En `frontend/src/ui/components.css`: (a) `.stepper__step--current .stepper__dot` → **`background`
...
- [ ] T008 [US3] Verificar **alcance sobre el DIFF FINAL** (tras T009/T010, no antes — H-001):
...
- [ ] T010 [US1] **Capturas Playwright MCP** en **claro y oscuro**, cada pantalla en **su viewport de rol**
