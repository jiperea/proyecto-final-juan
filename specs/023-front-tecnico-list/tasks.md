...
- [ ] T001 Verificar `make dev` (HMR) sirve el front en `:5173`; confirmar que los tokens/componentes de FE-8 (StatusBadge, Stepper, chip, `--font-mono`) están disponibles para reutilizar.
