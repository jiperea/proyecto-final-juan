...
import { toOrderRecord as toRecord } from './order-record';
...
// NOTA (024): el registro de ejecución (PrismaOrderExecutionRepository) vive en `order-execution-repository.ts`
// (mismo módulo de escritura de 005; separado por límite de tamaño de fichero, `max-lines`). Se re-exporta
// aquí para no romper imports existentes de este módulo.
export { PrismaOrderExecutionRepository } from './order-execution-repository';
