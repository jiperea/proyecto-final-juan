<!-- SPECKIT START -->
Plan activo: `specs/014-front-tecnico/plan.md` (+ quickstart.md; sin research/data-model/contracts — el contrato ya existe). FE-2: write-side del técnico (iniciar trabajo, registrar ejecución + evidencia metadato, enviar a revisión) sobre el shell de FE-1. G1 ✅ PASS (panel completo de front, 2 rondas). Evidencia a nivel de metadato (object_ref=UUID; binario=deuda #007). Historial: M12 CI/CD (010-013) cerrado; FE-1 (009) en develop.
