<!-- SPECKIT START -->
Plan activo: `specs/017-front-reskin/plan.md` (+ quickstart.md; sin research/data-model/contracts — feature de presentación, sin endpoints). **FE-5**: reskin transversal del front hacia el artifact de exploración (acento naranja, paleta de estados, radios/sombras suaves, Stepper del FSM, tarjeta de resumen IA) + **tema oscuro CSS-first** con conmutador (light/dark/system, localStorage). No amplía alcance funcional del brief; token o nada; WCAG 2.1 AA en ambos temas (test de ratios de 18 pares × 2 temas). G1 ✅ PASS (3 rondas) · G2 ✅ PASS · **G3 ✅ PASS** (impl+tests; 235 tests/lint/build/e2e en verde, 0 bloqueantes). Lista para PR a develop. Historial: FE-1..4 (009/014/015/016) cerradas; M12 CI/CD (010-013) cerrado.
