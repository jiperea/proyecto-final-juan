<!-- SPECKIT START -->
Plan activo: `specs/012-frontend-pipeline-hardening/plan.md` (+ quickstart.md; sin research/data-model/contracts — pipeline, no feature de app). Endurece el front de 010/011 tras la 1ª ejecución real: parcheo del SO del base image nginx/Alpine (Trivy) con manejo de privilegios no-root + smoke-test. G1 ✅ PASS (panel reducido, 3 rondas). Base: 010/011 ya en verde en CI.
